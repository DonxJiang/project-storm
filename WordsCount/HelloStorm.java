...
import WordsCount.WordCounterBolt;
import WordsCount.WordSpitterBolt;
import WordsCount.LineReaderSpout;
...
public class HelloStorm {
	...
	public static void main(String[] args) throws Exception{
		...
		String dir="/root/workspace/Testing/src/main/java/WordsCount/AnimalFarm.txt";
		config.put("inputFile", dir);
